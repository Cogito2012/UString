...
def clip_boxes_tf(boxes, im_info):
  b0 = tf.maximum(tf.minimum(boxes[:, 0], im_info[1] - 1), 0)  # x1
  b1 = tf.maximum(tf.minimum(boxes[:, 1], im_info[0] - 1), 0)  # y1
  b2 = tf.maximum(tf.minimum(boxes[:, 2], im_info[1] - 1), 0)  # x2
  b3 = tf.maximum(tf.minimum(boxes[:, 3], im_info[0] - 1), 0)  # y2
